...
<html lang="ru" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/style_clients.css">
...
<!-- Sprite -->
    ...
    <div class="wrapper">
      ...
      <div class="content">
        ...
        <div class="data">
          <div class="data__title">Клиенты</div>
            ...
            <table class="data__table">
              ...
              <?php
                ...
                if ($position == "Администратор") {
                  ...
                  echo '<tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th><th>Пароль</th><th>Скидка</th></tr>
                  <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th><th>Пароль</th><th>Скидка</th></tr>';

                  while (($us = mysqli_fetch_assoc($users))) {
                    echo
                      '<tr class="row"><td id="user_id">' . $us['user_id'] .
                      '</td><td id="user_fn">' . $us['user_fn'] .
                      '</td><td id="user_sn">' . $us['user_sn'] .
                      '</td><td id="user_fd">' . $us['user_fd'] .
                      '</td><td id="user_bd">' . $us['user_bd'] .
                      '</td><td id="user_phone">' . $us['user_phone'] .
                      '</td><td id="user_login">' . $us['user_login'] .
                      '</td><td id="user_password">' . $us['user_password'] .
                      '</td><td id="user_sale">' . $us['user_sale'] . '%</td><td><svg class="remove__icon"><use xlink:href="#remove"></use></svg></td></tr>';
                  }
                }
                  ...
                  echo '<tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th><th>Скидка</th></tr>
                  <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th><th>Скидка</th></tr>';
                  ...
                  echo '<tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th></tr>
                  <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Почта</th></tr>';
                  ...
                  while (($us = mysqli_fetch_assoc($users))) {
                    echo
                      ...
                      '</td><td id="user_bd">' . $us['user_bd'] .
                      '</td><td id="user_phone">' . $us['user_phone'] .
                      '</td><td id="user_login">' . $us['user_login'] . '</td><td><svg class="remove__icon"><use xlink:href="#remove"></use></svg></td></tr>';
                  }
                }
              ?>
      ...
      <form class="popup popup--add" action="functions/users/user_add.php">
        <div class="popup__title">Добавить клиента</div>
        <div class="popup__data">
          <input class="popup__input" type="number" name="user_id" value="" placeholder="Номер">
          <input class="popup__input" type="text" name="user_fn" value="" placeholder="Фамилия">
          <input class="popup__input" type="text" name="user_sn" value="" placeholder="Имя">
          <input class="popup__input" type="text" name="user_fd" value="" placeholder="Отчество">
          <input class="popup__input" type="date" name="user_bd" value="" placeholder="Дата рождения">
          <input class="popup__input" type="tel" name="user_phone" value="" placeholder="Телефон">
          <input class="popup__input" type="email" name="user_login" value="" placeholder="Почта">
          <input class="popup__input" type="password" name="user_password" value="" placeholder="Пароль">
          <input class="popup__input" type="text" name="user_sale" value="" placeholder="Скидка">
        </div>
      ...
      <form class="popup popup--change" action="functions/users/user_change.php">
