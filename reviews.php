...
<html lang="ru" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/style_reviews.css">
...
<!-- Sprite -->
    ...
    <div class="wrapper">
      ...
      <div class="content">
        ...
        <div class="data">
          <div class="data__title">Отзывы</div>
          ...
          <div class="data__content">
            <table class="data__table">
              <tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Телефон</th><th>Почта</th><th>Дата</th><th>Отзыв</th></tr>
              <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Телефон</th><th>Почта</th><th>Дата</th><th>Отзыв</th></tr>

              <?php
                  $reviews = mysqli_query($connection, "SELECT * FROM review JOIN user ON review.user_id = user.user_id");
                  while (($rev = mysqli_fetch_assoc($reviews))) {
                    echo
                      '<tr class="row"><td>' . $rev['review_id'] .
                      '</td><td>' . $rev['user_fn'] .
                      '</td><td>' . $rev['user_sn'] .
                      '</td><td>' . $rev['user_phone'] .
                      '</td><td>' . $rev['user_login'] .
                      '</td><td>' . $rev['review_date'] .
                      '</td><td>' . $rev['review_desc'] . '</td><td><svg class="remove__icon"><use xlink:href="#remove"></use></svg></td></tr>';
                  }
              ?>
    ...
    <form class="popup popup--add" action="functions/reviews/review_add.php">
        <div class="popup__title">Оставить отзыв</div>
        <div class="popup__data">
          <input class="popup__input" type="text" name="review_desc" value="" placeholder="Ваш отзыв">
        </div>
    ...
    <form class="popup popup--change" >
      <div class="popup__btns">
        <button class="popup__btn btn--cancel" type="button" name="button"></button>
        <button class="popup__btn btn--change" type="submit" name="button"></button>
      </div>
    </form>
