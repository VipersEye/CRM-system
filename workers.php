...
<!-- Sprite -->
    ...
    <div class="wrapper">
      <header class="header">
        <div class="intro">
          <a class="intro__title" href="./menu.php">
      ...
      <div class="content">
        ...
        <div class="data">
          <div class="data__title">Сотрудники</div>
            ...
            <table class="data__table">
              ...
              <?php
                ...
                if ($position == "Администратор") {
                  ...
                  echo '<tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Должность</th><th>Логин</th><th>Пароль</th></tr>
                  <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Должность</th><th>Логин</th><th>Пароль</th></tr>';

                  while (($wk = mysqli_fetch_assoc($workers))) {
                    echo
                      '<tr class="row"><td id="worker_id">' . $wk['worker_id'] .
                      '</td><td  id="worker_fn">' . $wk['worker_fn'] .
                      '</td><td  id="worker_sn">' . $wk['worker_sn'] .
                      '</td><td  id="worker_fd">' . $wk['worker_fd'] .
                      '</td><td  id="worker_bd">' . $wk['worker_bd'] .
                      '</td><td  id="worker_phone">' . $wk['worker_phone'] .
                      '</td><td  id="position">' . $wk['position'] .
                      '</td><td  id="worker_login">' . $wk['worker_login'] .
                      '</td><td  id="worker_password">' . $wk['worker_password'] . '</td><td><svg class="remove__icon"><use xlink:href="#remove"></use></svg></td></tr>';
                  }
                }
                  ...
                  echo '<tr class="table__head"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Должность</th><th>Логин</th></tr>
                  <tr class="table__firstrow"><th>№</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Дата рождения</th><th>Телефон</th><th>Должность</th><th>Логин</th></tr>';
                  ...
                  while (($wk = mysqli_fetch_assoc($workers))) {
                    echo
                      ...
                      '</td><td  id="worker_phone">' . $wk['worker_phone'] .
                      '</td><td  id="position">' . $wk['position'] .
                      '</td><td  id="worker_login">' . $wk['worker_login'] . '</td><td><svg class="remove__icon"><use xlink:href="#remove"></use></svg></td></tr>';
                  }
                }
              ?>
      ...
      <form class="popup popup--add" action="functions/workers/worker_add.php">
        <div class="popup__title">Добавить сотрудника</div>
        <div class="popup__data">
          <input class="popup__input" type="number" name="worker_id" value="" placeholder="Номер">
          <input class="popup__input" type="text" name="worker_fn" value="" placeholder="Фамилия">
          <input class="popup__input" type="text" name="worker_sn" value="" placeholder="Имя">
          <input class="popup__input" type="text" name="worker_fd" value="" placeholder="Отчество">
          <input class="popup__input" type="date" name="worker_bd" value="" placeholder="Дата рождения">
          <input class="popup__input" type="tel" name="worker_phone" value="" placeholder="Телефон">
          <input class="popup__input" type="text" name="position" value="" placeholder="Должность" list="Должности">
            <datalist id="Должности">
              <option value="Менеджер по продажам">
              <option value="Менеджер по закупкам">
              <option value="Грузчик">
              <option value="Курьер">
            </datalist>
          <input class="popup__input" type="email" name="worker_login" value="" placeholder="Логин">
          <input class="popup__input" type="password" name="worker_password" value="" placeholder="Пароль">
        </div>
      ...
      <form class="popup popup--change" action="functions/workers/worker_change.php">
